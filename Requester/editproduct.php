...
session_start();
 ...
 if(isset($_REQUEST['pupdate'])){
  ...
  if(($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") || ($_REQUEST['ptotal'] == "") || ($_REQUEST['poriginalcost'] == "") || ($_REQUEST['psellingcost'] == "") || ($_REQUEST['Reason'] == "")){
  ...
  $sql = "UPDATE assets_tb SET pname = '$pname', pdop = '$pdop', pava = '$pava', ptotal = '$ptotal', poriginalcost = '$poriginalcost', psellingcost = '$psellingcost' , Reason='$Reason' WHERE pid = '$pid'";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Update Facility Details</h3>
  <?php
 ...
 ?>
  <form action="" method="POST">
    <div class="form-group">
      <label for="pid">Facility ID</label>
    ...
    <div class="form-group">
      <label for="psellingcost">Brand Number</label>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="Reason" name="Reason" value="<?php if(isset($row['Reason'])) {echo $row['Reason']; }?>">
    </div>
