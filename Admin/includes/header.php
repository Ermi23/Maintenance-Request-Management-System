...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top bg-danger p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="dashboard.php">Administrator Page</a>
 </nav>
   ...
   <nav class="col-sm-3 col-md-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'Storemanager') { echo 'active'; } ?>" href="Storemanager.php">
        <i class="fas fa-users"></i>
        Store Manager
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'ExpertheadProfile') { echo 'active'; } ?>" href="expertshead.php">
        <i class="fas fa-users"></i>
        Experts Head
       </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link <?php if(PAGE=='viewrejected') { echo 'active'; } ?>" href="rejected.php">
        <i class="fas fa-table"></i>
        Rejected Requests
        </a>
        </li>
