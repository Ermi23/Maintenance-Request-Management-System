<?php    
define('TITLE', 'Update Storemanager');
...
session_start();
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  $sql = "UPDATE storemanager SET r_login_id = '$rid', r_name = '$rname', r_email = '$remail', r_password='$rpassword2' WHERE r_login_id = '$rid'";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Update Store Manager Details</h3>
  <?php
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM storemanager WHERE r_login_id = {$_REQUEST['id']}";
 ...
 ?>
  <form action="" method="POST">
    <div class="form-group">
      <label for="r_login_id">Store Manager ID</label>
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="pass" name="r_password" value="<?php if(isset($row['r_password'])) {echo $row['r_password']; }?>">
    </div>
