...
<div class="col-sm-4 mb-5">
  ...
  <?php 
 $sql = "SELECT request_id, request_info, request_desc, request_date, Approval FROM submitrequest_tb WHERE Approval = 'Not_Approved'";
 ...
 if($result->num_rows > 0){
  ...
  <p> you successfully Approve all Requests.</p>
  <hr>
  <h5 class="mb-0">No remain Requests</h5>
</div>';
 }
