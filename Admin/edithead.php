<?php    
define('TITLE', 'Update Experts Head');
...
session_start();
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  $sql = "UPDATE experthead SET r_login_id = '$rid', r_name = '$rname', r_email = '$remail', r_password='$rpassword2' WHERE r_login_id = '$rid'";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Update Head Details</h3>
  <?php
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM experthead WHERE r_login_id = {$_REQUEST['id']}";
 ...
 ?>
  <form action="" method="POST">
    <div class="form-group">
      <label for="r_login_id">Experts Head ID</label>
